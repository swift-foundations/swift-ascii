...
extension Binary.ASCII.Parsing.Machine.Access.Prefix where Output: Sendable {
    ...
    @inlinable
    public func call(_ bytes: [UInt8]) throws(Binary_Parser_Primitives.Binary.Bytes.Machine.Fault) -> (value: Output, count: Index<Byte>.Count) {
    ...
    ) throws(Binary_Parser_Primitives.Binary.Bytes.Machine.Fault) -> (value: Output, count: Index<Byte>.Count)
    ...
    @inlinable
    public func call(_ string: some StringProtocol) throws(Binary_Parser_Primitives.Binary.Bytes.Machine.Fault) -> (value: Output, count: Index<Byte>.Count) {
